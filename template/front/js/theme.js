...
var featuredProductsCarousel3 = $('#featured-products-carousel-3');
var featuredProductsCarousel4 = $('#featured-products-carousel-4');
var featuredProductsCarousel5 = $('#featured-products-carousel-5');
var featuredProductsCarousel6 = $('#featured-products-carousel-6');
var featuredProductsCarousel7 = $('#featured-products-carousel-7');
var featuredProductsCarousel8 = $('#featured-products-carousel-8');
var featuredProductsCarousel9 = $('#featured-products-carousel-9');
...
jQuery(document).ready(function () {
    ...
    if ($().owlCarousel) {
		...
		if (featuredProductsCarousel8.length) {
			featuredProductsCarousel8.owlCarousel({
				autoplay: true,
				autoplayHoverPause: true,
				loop:true,
				margin: 5,
		...
		if (featuredProductsCarousel9.length) {
			featuredProductsCarousel9.owlCarousel({
				autoplay: true,
				autoplayHoverPause: true,
				loop:true,
				margin: 5,
