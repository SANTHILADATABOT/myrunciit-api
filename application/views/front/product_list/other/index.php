                    ...
                    <div class="row">
                        <div class="col-md-10 col-sm-12 col-xs-12 sort-item">
                            <div class="form-inline">
                                ...
                                <div class="form-group widget hidden-xs" style="display:none;">
                                    <div class="widget-search">
                                        <input class="form-control" type="text" id="texted" value="<?php echo rawurldecode($text); ?>" placeholder="<?php echo translate('search'); ?>">
