                    ...
                    <div class="col-md-12">
                        ...
                        <span itemscope itemtype="http://schema.org/Person">
                            <div class="added_by" style="padding: 10px 0px;">
                                <i class="fa fa-user" style="line-height: 18px"></i>&nbsp;<?php echo translate('seller:').'<b itemprop="name" class="text-info" style="margin-left:4px">'.$this->db->get_where('user', array('user_id' => $row['added_by']))->row()->username.'</b>';?>
                            </div>
                            ...
                            <div class="added_by" style="padding-bottom: 10px;">
                                <i class="fa fa-envelope" style="line-height: 18px"></i>&nbsp;<?php echo translate('seller_email:').'<a href="mailto:'.$this->db->get_where('user', array('user_id' => $row['added_by']))->row()->email.'"><b itemprop="email" class="text-info" style="margin-left:4px">'.$this->db->get_where('user', array('user_id' => $row['added_by']))->row()->email.'</b></a>';?>
                            </div>
                            <div class="added_by" style="padding-bottom: 10px;">
                                ...
                                <?php echo translate('phone_no.:').'<a href="#" class="show_number" style="margin-left:4px;font-size: 16px;line-height: 18px;color:#860055;text-decoration: underline;"><b>Show Number</b></a><b itemprop="telephone" class="text-info number_text" style="margin-left:4px;font-size: 18px;line-height: 18px;display: none;">'.$phone.'</b>';?>
                            </div>
                        </span>
