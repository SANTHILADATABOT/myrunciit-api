            ...
            <table class="table-bordered table-hover" data-cat="<?php echo $row['category']; ?>">
                ...
                <tbody>
                    ...
                    <tr class="cat_<?php echo $row['category']; ?>">
                        ...
                        <?php
$sale_price = $this->db->get_where('product', array('product_id' => $p))->row()->sale_price;
$minAmount = $this->db->get_where('multiple_option', array('product_id' => $p))->row()->amount;
$discount = $this->db->get_where('product', array('product_id' => $p))->row()->discount;
