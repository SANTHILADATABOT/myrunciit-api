                                ...
                                <?php
                                    ...
                                    $cat_values = array();
                                        ...
                                        if($this->crud_model->if_publishable_category($row)){
                                         ...
                                         foreach($val as $vendor_check)
                                         {
                                            if (!in_array($vendor_check['category'], $cat_values)) {
                                            if($vendor_check['category']==$row)
                                            {
                                               $this->db->where('category_id',$vendor_check['category']);
                                               $category_get =$this->db->get('category')->result_array();
                                               foreach( $category_get as $vendor_category_check)
                                               {
                                ?>
                                    <li>
                                        <a href="<?php echo base_url(); ?>index.php/home/category/<?php echo $vendor_category_check[category_id]; ?>">
                                            <?php
                                                echo $this->crud_model->get_type_name_by_id('category',$vendor_category_check[category_id],'category_name');
                                            ?>
                                        </a>
                                    </li>
                                <?php
                                        $cat_values[] = $vendor_check['category'];
                                    }
                                }                               
                            }
                            }
