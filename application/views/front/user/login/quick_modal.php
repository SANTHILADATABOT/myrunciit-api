    ...
    <div class="row get_into" id="login">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row box_shape" style="box-shadow:none;">
                ...
                <div class="<?php if ($guest_checkout_set == 'ok') { ?>col-lg-6 col-md-6 col-sm-6 col-xs-6<?php } else { ?>col-lg-12 col-md-12 col-sm-12 col-xs-12<?php } ?>">
                    <span class="btn btn-theme-sm btn-block btn-theme-dark pull-right login_btn snbtn">
                        <?php echo translate('login'); ?>
                    </span>
                </div>
                <?php
                if ($guest_checkout_set == 'ok') { ?>
