...
?>
    <tr>
        ...
        <?php $minAmount = $this->db->get_where('multiple_option', array('product_id' => $row1['product_id']))->row()->amount; ?>
        <td class="price"><?php echo ($this->crud_model->get_product_price($row1['product_id'], $minAmount)); ?></td>
        <td class="add">
