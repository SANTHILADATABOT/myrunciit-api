    ...
    <tr>
        ...
        <td class="view_details">
            <?php 
                ...
                ?>
                    <span class="btn btn-info btn-sm" style="cursor:pointer;" onclick="view_package_details('<?php echo base_url(); ?>index.php/home/profile/view_package_details/<?php echo $row1['package_payment_id']; ?>')" >
