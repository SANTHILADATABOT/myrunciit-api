...
<section class="page-section featured-products">
    ...
    <div class="container">
        <div class="featured-products-carousel col-md-11">
            ...
            { ?>
                ...
                <?php if($i0<count($catg_list1)){ ?>
                    <div class="media">
                        <div class="media-link image_delay">
                            <center><img src="<?php echo $catg_list1[$i0]["imgsrc"]; ?>" style="width:150px;height:150px;" /></center>
                        </div>
                    </div>
                ...
                <?php if($i0<count($catg_list2)){ ?>
                    <div class="media">
                        <div class="media-link image_delay">
                            <center><img src="<?php echo $catg_list2[$i0]["imgsrc"]; ?>" style="width:150px;height:150px;" /></center>
                        </div>
                    </div>
                    <div class="caption text-center">
        ...
        <div class="col-md-1">
            <h4 class="caption-title1"><a href="<?php echo base_url()."index.php/home/category/"; ?>">Show All</a></h4>
        </div>
    </div>
</section>
