...
<section class="page-section featured-products">
    ...
    <div class="container">
        <div class="featured-products-carousel col-md-12">
            <div class="owl-carousel" id="featured-products-carousel-7">
            <?php
	...
	<div class="col-md-12">
         <center><h4 class="caption-title1"><a href="<?php echo base_url()."index.php/home/category/"; ?>">Show All</a></h4></center>
    </div>
	</div>
