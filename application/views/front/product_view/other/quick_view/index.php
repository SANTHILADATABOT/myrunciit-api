            ...
            <div class="product-price">
                    ...
                    <?php } else { ?>
                        ...
                        <ins><span id="displayAmt"><sup>
                            <?php echo currency(); ?></sup><?php echo number_format($minAmount,2); ?></span>
                        	<unit><?php echo ' /'.$row['unit'];?></unit>
                        </ins>
					<?php 
					} 
					...
					else 
					{
                            ...
                            //////////////////////////////////////
                            $discount= $this->db->get_where('product',array('product_id'=>$row['product_id']))->row()->discount ;
                            $sale_price= $this->db->get_where('product',array('product_id'=>$row['product_id']))->row()->sale_price ;

                            $number1 = ($sale_price - ($discount * $sale_price / 100));

							// $displayAmt_price=$this->crud_model->get_product_price($row['product_id']);
                            // echo "disp--".$sale_price."--disp";
							$displayAmt_price=($number1!="")?floatval($number1):0;
                     ...
                     <script>
                        ...
                        <ins><sup><?php echo currency(); ?></sup>
							<?php echo number_format($displayAmt_price,2); ?>
                            <unit><?php echo ' /'.$row['unit'];?></unit>
                        </ins>  
