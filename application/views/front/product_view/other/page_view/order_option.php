...
?>
                ...
                ?>
                    ...
                    <?php
                        ...
                        foreach ($option as $op) 
						{
							//echo $title;
                    ?>
                      <input type="radio" onclick="return  pricevariant();" class="optional" name="<?php echo $name;?>" <?php if(isset($otherOptionss[str_replace(" ",'_',$title)]) && $otherOptionss[str_replace(" ",'_',$title)]==$op ) { ?> checked="checked" <?php } elseif($i==2) { ?> checked="checked" <?php } ?> value="<?php echo $op;?>" <?php if($this->crud_model->is_added_to_cart($row['product_id'], 'option', $name) == $op){ echo 'checked'; } ?> id="<?php echo $name.'_'.$i; ?>">
							...
							if(data!=0)
								{
                                    ...
                                    $("#displayAmt_price").val(data1[0].replace('RM ',''));
    ...
    <div class="buttons" style="display:inline-flex;">
        <span class="btn btn-add-to cart" onClick="showPopup(event,<?php echo $row['product_id']; ?>,<?php echo $row['store_id']; ?>)">
...
<div class="buttons">
    <div id="share"></div>
    <a href="https://api.whatsapp.com/send?text=www.google.com" target="_blank" data-action="share/whatsapp/share"><img src="<?php echo base_url(); ?>uploads/whatsapp.png" width="32px;" style="margin-left: 110px;margin-top: -75px;" ></a>
</div>
