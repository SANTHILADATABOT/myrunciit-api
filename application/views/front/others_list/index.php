...
<input type="hidden" value="<?php echo $sub_category; ?>" id="sub_category" />
<input type="hidden" value="<?php echo $min; ?>" id="min" />
<input type="hidden" value="<?php echo $max; ?>" id="max" />
<input type="hidden" value="<?php echo $query; ?>" id="query_val" />
...
<!-- /PAGE WITH SIDEBAR -->
<script>
	function product_by_type(type,category,sub_category,brand,min,max,query_val){	
		var top = Number(200);
		...
		$("#page_content").load("<?php echo base_url()?>index.php/home/product_by_type/"+type+"/"+category+"/"+sub_category+"/"+brand+"/"+min+"/"+max+"/"+query_val);
	}
	$(document).ready(function(){
        ...
        var min=$('#min').val();
        var max=$('#max').val();
        var query_val=$('#query_val').val();
		product_by_type(product_type,category,sub_category,brand,min,max,query_val);
    });
</script>
