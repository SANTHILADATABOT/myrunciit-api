<?php
function amount_display1($amount)
{
    $amount1=0;
    foreach($amount as $amount0)
    {if($amount0!=''){$amount1+=floatval($amount0."");}}
    return currency().number_format($amount1,2);
}
?>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="invoice_body">
                    ...
                    <?php if(($order_details[0]['pre_order_status']!='') || ($order_details[0]['pre_order_date']!='')){ ?>
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6 ">
                            <address>
                                <strong>
                                    <h4>
                                        <?php echo translate('pre_order_details'); ?> :
                                    </h4>
                                </strong>
                                <?php if($order_details[0]['pre_order_status']!=''){ ?>
                                <p>
                                    <b><?php echo translate('pre_order_status'); ?> :</b>
                                    <i><?php echo translate($order_details[0]['pre_order_status']); ?></i>
                                </p>
                                <?php } ?>
                                <?php if($order_details[0]['pre_order_date']!=''){ ?>
                                <p>
                                    <b><?php echo translate('pre_order_date'); ?> :</b>
                                    <i><?php echo $order_details[0]['pre_order_date']; ?></i>
                                </p>
                                <?php } ?>
                            </address>
                        </div>
                                ...
                                <table class="table table-condensed">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="text-right"><strong><?php echo translate('Tax');?></strong></td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
												<?php echo amount_display1([$row1['price']]); ?>
                                            </td>
                                            <td class="text-right"><?php echo amount_display1([$row1['tax']]); ?></td>
                                            <td class="text-right"><?php echo amount_display1([$row1['shipping']]); ?></td>
                                            <td class="text-right">
												<?php echo amount_display1([$row1['price'],$row1['tax'],$row1['shipping']]); 
                                        ...
                                        <tr>
                                            ...
                                            <td class="thick-line text-right">
                                            	<?php echo amount_display1([$subtotal]);?>
                                            </td>
                                        </tr>
                                        <tr>
                                        	<td class="no-line"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="no-line text-right">
                                            	<?php echo amount_display1([$shipping]);?>
                                            </td>
                                        </tr>
                                        <?php } */ ?>
                                        <tr>
                                            ...
                                            <td class="no-line text-right">
                                            	<strong>
                                            		<?php echo translate('delivery_charge');?> :
                                                </strong>
                                            </td>
                                            <td class="no-line text-right">
                                                <?php
                                                    ...
                                                    if($row['lalamove_res']!="")
                                                    {
                                                        $lalamove_res = json_decode($row['lalamove_res'],true);
                                                    ...
                                                    echo amount_display1([$delivery_charge]);
                                                ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="no-line text-right">
                                            	<?php echo amount_display1([$total,$delivery_charge]);?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <?php
											foreach($order_details as $row) {
											    $discount_details = json_decode($row['discount'], true);
											$product_details = json_decode($row['product_details'], true);
											...
											foreach ($product_details as $row1) {
												...
												$total += $tax+$shipping+$subtotal-$discount;
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><?php echo amount_display1([$row1['tax'] * $row1['qty']] ); ?></td>
                                            <!-- <td class="text-right"><?php echo amount_display1([$row1['shipping']]); ?></td> -->
                                            <td class="text-right">
												<?php echo amount_display1([$row1['subtotal']]); 
                                        ...
                                        <tr>
                                            ...
                                            <td class="no-line text-right">
                                                ...
                                                <?php 
                                                echo currency() .number_format($discount,2);?>
                                            </td>
                                        </tr>
                                        <tr>
                                        	<td class="no-line"></td>
...
<?php if($ipay88_success=="yes"){ ?>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script>
$(document).ready(function(){
    //alert("<?php //echo $ipay88_success; ?>");
	Swal.fire(
		'',
		'<h4><?php echo translate('ipay88_payment_success');?></h4>',
		'success'
	);
});
</script>
