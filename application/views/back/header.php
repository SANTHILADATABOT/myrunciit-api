        ...
        <div class="navbar-content clearfix">
            <ul class="nav navbar-top-links pull-left">
                ...
                <li class="tgl-menu-btn">
                    <a class="mainnav-toggle" onclick="change_main_title_icon1()">
            ...
            <script>
                var mainnav_container_width = 0;
                $(document).ready(function() {
                    mainnav_container_width = $('#mainnav-container').width();
                });
                function change_main_title_icon1()
                {
                    var w1=$('#mainnav-container').width();
                    var ch=(mainnav_container_width > w1);
                    document.getElementById("main-title-icon1").style.display = ch?"block":"none";
                    document.getElementById("main-title-icon2").style.display = ch?"none":"block";
                    mainnav_container_width = w1;
                }
            </script>
