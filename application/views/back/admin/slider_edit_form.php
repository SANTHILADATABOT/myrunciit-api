                    ...
                    <div style="width:100%; overflow: hidden !important;" id="preview_div">
                        ...
                        <div id="backup_slider" style="display:none;">
                            <div class="ls-slide" <?php echo $style['full_slide_style']; ?> >
                                ...
                                <?php } ?>
                                <?php foreach($style['texts'] as $ind => $text){ ?>
                                    <<?php echo $text['element']; ?> class="ls-l out_<?php echo $text['name']; ?>" style="<?php echo $text['style']; ?>  color:<?php echo $text['color']; ?>; background:<?php echo $text['background']; ?>;font-family: <?php echo $txts[$ind]['fontFamily']?>" data-ls="<?php echo $text['data_ls']; ?>" >
                ...
                <div class="col-md-12 margin-top-30">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
							...
							<?php echo translate('select_background_image size(1349 * 500)');?></label>
                            <div class="col-sm-6">
                ...
                <div class="col-md-12 margin-top-20">
                	...
                	<div class="col-md-6">
                        ...
                        ?>
                            ...
                            <div class="form-group spec_txt_group" data-typ="<?php echo $text['name']; ?>_fontFamily" style="display:block;">
                                <label class="col-sm-5 control-label" for="demo-hor-inputemail">
                                    <?php echo translate('Font Family');?>
                                        </label>
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <select name="<?php echo $text['name']; ?>_fontFamily" value="<?php echo $fontFamily; ?>" class="form-control in_<?php echo $text['name']; ?>_fontFamily">
                                        <?php foreach($fontFamilyList as $singleFont):?>
                                        <option value="<?php echo $singleFont?>" <?php if($singleFont == $fontFamily) { ?> selected <?php }?>><?php echo $singleFont?></option>
                                        <?php endforeach?>
                                    </select>
