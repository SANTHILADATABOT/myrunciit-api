                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                <span class="pull-left btn btn-default btn-file"> <?php echo translate('choose_file');?>
                                    <input type="file"  name="video" onchange="preview_video(this); id="demo-hor-18" class="form-control">
                                    </span>
...
<script type="text/javascript">
    ...
    if (input.files && input.files[0]) {
        ...
        $(input.files).each(function(index, file) {
            ...
            reader.onload = function(e) {
                // Create a video element for each uploaded video
                var videoElement = document.createElement("video");
                videoElement.controls = true;
                videoElement.height = 100;
                videoElement.innerHTML = "<source src='" + e.target.result + "' type='" + file.type + "'>";
                $("#previewvedio").append("<div></div>").append(videoElement);
            };
        });
    }
};
