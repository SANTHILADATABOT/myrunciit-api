...
<div class="row">
    <div class="col-md-12">
        <?php
            echo form_open(base_url() . 'index.php/admin/product_bundle/update/'. $row['product_id'], array(
                    ...
                    <div class="tab-content">
                        <div id="bundle_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border" data-no="<?php echo $product['product_no']; ?>">
                                ...
                                <div class="col-sm-4" id="quant<?php echo $product['product_no']; ?>">
                                ...
                                <div class="col-sm-4" id="sub<?php echo $product['product_no']; ?>">
                                ...
                                <div class="col-sm-4" id="brn<?php echo $product['product_no']; ?>">
                                ...
                                <div class="col-sm-4" id="prod<?php echo $product['product_no']; ?>">
...
<script>
    ...
    function get_cat(id,now){
        ...
        $('#brn'+co).hide('slow');
        $('#prod'+co).hide('slow');
        ajax_load(base_url+'index.php/admin/product_bundle/sub_by_cat/'+id,'sub_cat'+co,'other');
        $('#sub'+co).show('slow');
    }
    function get_brnd(id,now){
        ...
        $('#brn'+co).hide('slow');
        $('#prod'+co).hide('slow');
        ajax_load(base_url+'index.php/admin/product_bundle/brand_by_sub/'+id,'brand'+co,'other');
        $('#brn'+co).show('slow');
    }
    function get_prod(id,now){
        ...
        $('#prod'+co).hide('slow');
        ajax_load(base_url+'index.php/admin/product_bundle/prod_by_brand/'+id+'/'+sub_cat+'/'+cat,'product'+co,'other');
        $('#prod'+co).show('slow');
    }
    ...
    $("#more_btn").click(function(){
        ...
        $("#more_additional_fields").append(''
            ...
            +'        <span class="remove_it_v rmc btn btn-danger btn-icon icon-lg fa fa-trash" ></span>'
            +'    </span>'
            +'    <div class="col-sm-4" id="quant'+co+'">'
