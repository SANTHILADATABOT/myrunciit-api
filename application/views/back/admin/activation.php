<?php
	...
	$razorpay_set = $this->db->get_where('business_settings', array(
        'type' => 'razorpay_set'
    ))->row()->value;
    
	$iyzipay_set = $this->db->get_where('business_settings', array(
        'type' => 'iyzipay_set'
    ))->row()->value;
	$multi_store_set = $this->db->get_where('business_settings', array(
        'type' => 'multi_store_set'
    ))->row()->value;
    $shiprocket = $this->db->get_where('business_settings', array(
        'type' => 'shiprocket'
    ))->row()->value;
    // $shiprocket = $this->db->get_where('business_settings', array(
    //     'type' => 'subscribe'
    // ))->row()->value;
    $cc_set = $this->db->get_where('business_settings', array(
        'type' => 'cc_set' ))->row()->value;
?>          
                        ...
                        <div class="col-md-4">
                            <div class="panel">
                                <div class="panel-heading bg-white">
                                    <center>
                                        <h4 class="panel-title">
                                            <?php echo translate('cashback_system')?>
                                        </h4>
                                    </center>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                            <input class='aiz_switchery1' type="checkbox"
                                                   data-set='cashback_system'
                                                   data-id='100'
                                                   data-tm='<?php echo translate('cashback_system_enabled'); ?>'  data-fm='<?php echo translate('cashback_system_disabled'); ?>'
                                                   <?php if($this->crud_model->get_settings_value('general_settings', 'cashback_system', 'value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel">
                                <div class="panel-heading bg-white">
                                    <center>
                                        <h4 class="panel-title">
                                            <?php echo translate('cashback_wallet_system')?>
                                        </h4>
                                    </center>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                            <input class='aiz_switchery1' type="checkbox"
                                                   data-set='cashback_wallet_system'
                                                   data-id='101'
                                                   data-tm='<?php echo translate('cashback_wallet_system_enabled'); ?>'  data-fm='<?php echo translate('cashback_wallet_system_disabled'); ?>'
                                                   <?php if($this->crud_model->get_settings_value('general_settings', 'cashback_wallet_system', 'value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                            <input class='aiz_switchery1' type="checkbox"
                                                   data-set='enquiry'
                                                   data-id='104'
                                                   data-tm='<?php echo translate('enquiry_enabled'); ?>'  data-fm='<?php echo translate('enquiry_disabled'); ?>'
                                                   <?php if($this->crud_model->get_settings_value('general_settings', 'enquiry', 'value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                            <input class='aiz_switchery1' type="checkbox"
                                                   data-set='callnow'
                                                   data-id='105'
                                                   data-tm='<?php echo translate('callnow_enabled'); ?>'  data-fm='<?php echo translate('callnow_disabled'); ?>'
                                                   <?php if($this->crud_model->get_settings_value('general_settings', 'callnow', 'value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                            <input class='aiz_switchery1' type="checkbox" name="shiprocket" id="id2"
                                                   data-set='shiprocket'
                                                   data-id='' value="ok"
                                                   data-tm='<?php echo translate('shiprocket_enabled'); ?>'  data-fm='<?php echo translate('shiprocket_disabled'); ?>'
                                                   <?php if($shiprocket == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                            <input class='aiz_switchery1' type="checkbox"
                                                   data-set='subscribe'
                                                   data-id='107'
                                                   data-tm='<?php echo translate('subscribe_enabled'); ?>'  data-fm='<?php echo translate('subscribe_disabled'); ?>'
                                                   <?php if($this->crud_model->get_settings_value('general_settings', 'subscribe', 'value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                            <input class='aiz_switchery1' type="checkbox"
                                                   data-set='rewards'
                                                   data-id='109'
                                                   data-tm='<?php echo translate('rewards_enabled'); ?>'  data-fm='<?php echo translate('rewards_disabled'); ?>'
                                                   <?php if($this->crud_model->get_settings_value('general_settings', 'rewards', 'value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel">
                                <div class="panel-heading bg-white">
                                    <center>
                                        <h4 class="panel-title">
                                            <?php echo translate('razorpay_activation')?>
                                        </h4>
                                    </center>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                           <input class='aiz_switchery1' type="checkbox" name="razorpay_set" id="id2"                                 data-set='razorpay_set'  value="ok"
                                                        data-id=''
                                                            data-tm='<?php echo translate('razorpay_payment_enabled'); ?>'
                                                                data-fm='<?php echo translate('razorpay_payment_disabled'); ?>'
                                                                <?php if($razorpay_set == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                         ...
                         <div class="col-md-4">
                            <div class="panel">
                                <div class="panel-heading bg-white">
                                    <center>
                                        <h4 class="panel-title">
                                            <?php echo translate('iyzipay_activation')?>
                                        </h4>
                                    </center>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                           <input class='aiz_switchery1' type="checkbox" name="iyzipay_set" id="id2"                                 data-set='iyzipay_set'  value="ok"
                                                        data-id=''
                                                            data-tm='<?php echo translate('iyzipay_payment_enabled'); ?>'
                                                                data-fm='<?php echo translate('iyzipay_payment_disabled'); ?>'
                                                                <?php if($iyzipay_set == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel">
                                <div class="panel-heading bg-white">
                                    <center>
                                        <h4 class="panel-title">
                                            <?php echo translate('multistore_activation')?>
                                        </h4>
                                    </center>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                           <input class='aiz_switchery1' type="checkbox" name="multi_store_set" id="id2"                                 data-set='multi_store_set'  value="ok"
                                                        data-id=''
                                                            data-tm='<?php echo translate('multi_store_enabled'); ?>'
                                                                data-fm='<?php echo translate('multi_store_disabled'); ?>'
                                                                <?php if($multi_store_set == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel">
                                <div class="panel-heading bg-white">
                                    <center>
                                        <h4 class="panel-title">
                                            <?php echo translate('ccavenue_payment_activation')?>
                                        </h4>
                                    </center>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                           <input class='aiz_switchery1' type="checkbox" name="cc_set" id="id2"                                 data-set='cc_set'  value="ok"
                                                        data-id=''
                                                            data-tm='<?php echo translate('ccavenue_payment_enabled'); ?>'
                                                                data-fm='<?php echo translate('ccavenue_payment_disabled'); ?>'
                                                                <?php if($cc_set == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
