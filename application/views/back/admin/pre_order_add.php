<div>
    <?php
		echo form_open(base_url() . 'index.php/admin/pre_order/do_add/', array(
	...
	?>
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="datetime-local" name="start_date" id="datetimepicker" 
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="datetime-local" name="end_date" id="datetimepicker1" 
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                <textarea class="summernotes" name="description" data-height="700" data-name="content" rows="20" style="width: 100%;"></textarea>
                </div>
            </div>
