		...
		<div class="panel">
			<div class="panel-body">
                <div class="tab-content">
                    ...
                    <div class="col-md-9">
                        <?php if($user_rights_19_0['add_rights']=='1'){ ?>
                        ...
                        <?php } ?>
                        <button class="btn btn-info btn-labeled fa fa-plus-circle add_pro_btn pull-right hidden" 
                        	onclick="ajax_set_list()">
								<?php echo translate('slider_list');?>
                        </button>
                        <button class="btn btn-purple btn-labeled fa fa-align-justify add_pro_btn pull-right hidden" 
