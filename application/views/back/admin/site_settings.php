...
<div class="content-wrapper-before"></div>
    ...
    <div class="tab-base">
        <div class="panel">
			...
			<div class="row">
			  <div class="col-md-12">
			    <h1 class="page-header text-overflow"><?php echo translate('Site Settings');?></h1>
			  </div>
		    </div>
                ...
                <div class="tab-content bg_grey">
                            ...
                            ?>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label class="col-sm-3 control-label" ><?php echo translate('year');?></label>
                                        <div class="col-sm-6">
                                            <input type="text" name="year" value="<?php echo $this->crud_model->get_type_name_by_id('general_settings','106','value'); ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" >
											<?php echo translate('website_power_mode');?>
                                            	</label>
                                        <div class="col-sm-6">
                                            <input id="power" class='sw4' data-set='set_power' type="checkbox" <?php if($this->crud_model->get_type_name_by_id('general_settings','112','value') == 'on'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                    ...
                    <div id="demo-stk-lft-tab-6"
                        ...
                        <div class="panel-inr">
                            ...
                            <?php
                            echo form_open(base_url() . 'index.php/admin/affiliation_settings/set/', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'id' => '',
                                'enctype' => 'multipart/form-data'
