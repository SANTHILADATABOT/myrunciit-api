                            ...
                            <div class="form-group spec_txt_group" data-typ="<?php echo $text['name']; ?>_fontFamily" style="display:block;">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <select name="<?php echo $text['name']; ?>_fontFamily" value="<?php echo $text['fontFamily']; ?>" class="form-control in_<?php echo $text['name']; ?>_fontFamily">
                                        <?php foreach($fontFamilyList as $singleFont):?>
                                        <option value="<?php echo $singleFont?>"><?php echo $singleFont?></option>
                                        <?php endforeach?>
                                    </select>
