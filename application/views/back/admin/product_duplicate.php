...
<div class="row">
    <div class="col-md-12">
        <?php
			echo form_open(base_url() . 'index.php/admin/product/duplicate_new/' . $row['product_id'], array(
				'class' => 'form-horizontal',
				'method' => 'post',
				'id' => 'product_duplicate',
                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <?php echo $this->crud_model->select_html('vendor','vendor','name','edit','demo-chosen-select required',$row['store_id'],'',NULL,''); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="unit" id="demo-hor-5" value="<?php echo $row['unit']; ?>" placeholder="<?php echo translate('unit_of_measurement_(e.g._kg,_pc_etc.)'); ?>" class="form-control unit required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                <span class="pull-left btn btn-default btn-file"> <?php echo translate('choose_file');?>
                                    <input type="file"  name="video" id="demo-hor-18" class="form-control">
                                    </span>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <?php
                                            $videos = $this->crud_model->file_view1('product',$row['product_id']);
                                            if(file_exists('uploads/product_image/product_'.$row['product_id'])){ 
                                                 $a = explode('.', $videos);
                                                 $a = $a[(count($a)-1)];
                                                 $a = explode('_', $a);
                                                 $p = $a[(count($a)-1)];
                                    ?>
                                        <div class="delete-div-wrap1">
                                            <div class="inner-div">
                                                <video controls class="img-responsive main-img">
                                                        <source src="<?php echo $videos?>" data-id="<?php echo $p; ?>">
                                                </video>
                                            </div>
                                        </div>
                                    <?php 
                            ...
                            <?php
                             ...
                             <div class="form-group btm_border auto_h">
                                ...
                                <input type="radio" name="enquiry" id="watch-me" style="height:10px;" value="ok" class="3dc" <?php if($row['enquiry']=='ok') { ?> checked <?php } ?>> Yes</label>
								 <label><input type="radio" name="enquiry" style="height:10px;" value="no" class="3dc" <?php if($row['enquiry']=='no') { ?> checked <?php } ?>> No</label>
                            ...
                            <?php
                             ...
                             <div class="form-group btm_border auto_h">
                               ...
                               $subscribe=$this->db->get_where('general_settings',array('type'=>'subscribe'))->row()->value;
                                ...
                                <input type="radio" name="subscribe" id="watch-me" style="height:10px;" value="ok" class="3dc" <?php if($row['subscribe']=='ok') { ?> checked <?php } ?>> Yes</label>
								 <label><input type="radio" name="subscribe" style="height:10px;" value="no" class="3dc" <?php if($row['subscribe']=='no') { ?> checked <?php } ?>> No</label>
                            ...
                            <?php
                             ...
                             <div class="form-group btm_border auto_h">
                                ...
                                $call=$this->db->get_where('general_settings',array('type'=>'callnow'))->row()->value;
                                ?>
                                <label><input type="radio" name="callnow" id="watch-me" style="height:10px;" value="ok" class="3dc" <?php if($row['callnow']=='ok') { ?> checked <?php } ?>> Yes</label>
								 <label><input type="radio" name="callnow" style="height:10px;" value="no" class="3dc" <?php if($row['callnow']=='no') { ?> checked <?php } ?>> No</label>
                            ...
                            <?php } ?>
                              ...
                              <div class="form-group btm_border auto_h" style="display:none;">
                                <label class="col-sm-4 control-label" for="demo-hor-11"><?php echo translate('AR');?></label>
                                <div class="col-sm-2">
                                
                                <label><input type="radio" name="ar" <?php if($row['ar']==1) { ?> checked="checked" <?php } ?> id="watch-me" style="height:10px;" value="1" class="3dc"> Yes</label>
								 <label><input type="radio" name="ar" <?php if($row['ar']==0) { ?> checked="checked" <?php } ?> style="height:10px;" value="0" class="3dc"> No</label>
                                    
                                </div>
                            </div>
                            <div class="show1" <?php if($row['ar']==1) { ?> style="display:block !important; <?php } ?>">
                            <div class="form-group btm_border">
                            ...
                            <div class="form-group btm_border">
                              ...
                              <div class="form-group btm_border" style="display:none;">
                                ...
                                <div class="col-sm-6">
                                                                <input type="checkbox" style="height:10px;" name="threed" value="1" class="form-control" <?php if ($row['threed'] == '1') echo "checked='checked'"; ?>> 
                            ...
                            <div class="form-group btm_border" style="display:none;">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="threed_url" placeholder="<?php echo translate('3D_url');?>" value="<?php echo $row['threed_url']; ?>" class="form-control">
                                </div>
                            </div>
                        ...
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="shipping_cost" min='0' id="demo-hor-8" min='0' step='.01' value="<?php echo $row['shipping_cost']; ?>" placeholder="<?php echo translate('purchase_shipping_cost');?>" class="form-control">
                                </div>
                                <span class="btn"><?php echo currency('','def'); ?> / </span>
                                <span class="btn unit_set"><?php echo $row['unit']; ?></span>
                            </div>
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="tax" id="demo-hor-9" min='0' step='.01' value="<?php echo $row['tax']; ?>" placeholder="<?php echo translate('purchase_product_tax');?>" class="form-control">
                                </div>
                                <div class="col-sm-1">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="discount" id="demo-hor-10" min='0' step='.01' value="<?php echo $row['discount']; ?>" placeholder="Sale Product Discount" class="form-control">
                                </div>
                                <div class="col-sm-1">
                            ...
                            <div class="form-group btm_border" style="display:none;">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="cashpack" id="demo-hor-9" min='0' step='.01' value="<?php echo $row['cashpack']; ?>" placeholder="<?php echo translate('cashpack');?>" class="form-control">
                                </div>
                                <div class="col-sm-1">
                                    <select class="demo-chosen-select" name="cashpack_type">
                                        <option value="percent" <?php if($row['cashpack_type'] == 'percent'){ echo 'selected'; } ?> >%</option>
                                        <option value="amount" <?php if($row['cashpack_type'] == 'amount'){ echo 'selected'; } ?> >Flat</option>
                                    </select>
                                </div>
                                <span class="btn unit_set">/<?php echo $row['unit']; ?></span>
                            </div>
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-10">
                     ...
                     <div class="col-md-2">
                     	<span class="btn btn-success form-control-inr4 btn-md btn-labeled fa fa-upload pull-right enterer" onclick="form_submit('product_duplicate','<?php echo translate('successfully_duplicated!'); ?>');proceed('to_add');" ><?php echo translate('duplicate');?></span> 
                     </div>
                </div>
            </div>
        </form>
