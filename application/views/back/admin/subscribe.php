...
<div class="content-wrapper-before"></div>
	...
	<div id="page-title">
		<h1 class="page-header text-overflow" ><?php echo translate('manage_subscribe');?></h1>
	</div>
	<div class="tab-base">
		<div class="panel">
				...
				<div class="tab-content">
					<div style="border-bottom: 1px solid #ebebeb;padding: 25px 5px 5px 5px;"
						...
						<button class="btn btn-primary btn-labeled fa fa-plus-circle pull-right mar-rgt" 
                        	onclick="ajax_modal('add','<?php echo translate('add_subscribe'); ?>','<?php echo translate('successfully_added!'); ?>','subscribe_add','')">
								<?php echo translate('create_subscribe');?>
                                	</button>
					</div>
					<br>
