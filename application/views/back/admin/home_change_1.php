        ...
        <div class="tab-base horizontal-tab">
            <ul class="nav nav-tabs">
                ...
                <li>
                 ...
                 <li style="display:none;">
                    <a data-toggle="tab" href="#tabb-12"><?php echo translate('todays_deal'); ?></a>
                </li>
                <li style="display:none;">
				...
				?>
                <li>
                    <a data-toggle="tab" href="#tabb-6"><?php echo translate('category_wise'); ?></a>
                </li>
                <li>
                ...
                <li>
                    <a data-toggle="tab" href="#tabb-13"><?php echo translate('delivery_slot'); ?></a>
                </li>
            </ul>
            <!--Tabs Content-->                    
            <div class="tab-content">
                	...
                	<div class="row">
                    	<div class="col-md-12 form-horizontal">
							...
							?>
                                ...
                                <div class="form-group deal hidden">
                	...
                	<div class="row">
                    	<div class="col-md-12 form-horizontal">
							...
							?>
                                ...
                                <div class="form-group hidden" style="margin-top:100px;">
                                    <label class="col-sm-3 control-label" style="margin-top:15px;" ><?php echo translate('choose_product_box_style');?></label>
                                    <div class="col-sm-6">
                                        <div class="row">
                                        <?php 
                ...
                <div id="tabb-11" class="tab-pane fade">
                  ...
                  <div id="tabb-13" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <?php
                            echo form_open(base_url() . 'admin/ui_settings/delivery_slot/', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'id' => '',
                                'enctype' => 'multipart/form-data'
                            ...
                            ?>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo translate('delivery_slot_(_show_/_hide_)');?></label>
                                <div class="col-sm-6">
                                    <input id="delivery_slot"
                                           data-id="107" class='sw8'
                                           type="checkbox" name="delivery_slot"
                            ...
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer" type= data-ing='<?php echo translate('updating'); ?>' data-msg='<?php echo translate('delivery_slot_section_updated!'); ?>'>
                                    <?php echo translate('update');?>
                                </span>
                            </div>
                            </form>
                ...
                <div id="tabb-12" class="tab-pane fade" style="display:none;">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <?php
                            echo form_open(base_url() . 'index.php/admin/ui_settings/ui_home/todays_deal/', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'id' => '',
                                'enctype' => 'multipart/form-data'
...
$(document).ready(function() {
	...
	$(".sw3").each(function() {
            ...
            changeCheckbox.onchange = function() {
                ajax_load('<?php echo base_url(); ?>index.php/admin/ui_settings/ui_home/product_bundle_publish_set/' + $(this).data('id') + '/' + changeCheckbox.checked, '', '');
                if (changeCheckbox.checked == true) {
                    $.activeitNoty({
                        type: 'success',
                        icon: 'fa fa-check',
		 ...
		 $(".sw8").each(function() {
                new Switchery(document.getElementById('customer_product_' + $(this).data('id')), {
                    color: 'rgb(100, 189, 99)'
                });
                var changeCheckbox = document.querySelector('#customer_product_' + $(this).data('id'));
                changeCheckbox.onchange = function() {
                    ajax_load('<?php echo base_url(); ?>index.php/admin/ui_settings/ui_home/customer_product_publish_set/' + $(this).data('id') + '/' + changeCheckbox.checked, '', '');
            if (changeCheckbox.checked == true) {
                $.activeitNoty({
                    type: 'success',
                    icon: 'fa fa-check',
