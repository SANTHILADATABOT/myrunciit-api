    ...
    <table id="demo-table" class="table table-striped" data-export-types="['excel','pdf']" data-show-export="true"  data-pagination="true" data-show-refresh="true"  data-show-toggle="true" data-show-columns="true" data-search="true" >
        ...
        <thead>
            <tr>
                ...
                <?php /*<th><?php echo translate('cancel_remarks');?></th>*/ ?>
        ...
        <tr class="<?php if($row['viewed'] !== 'ok'){ echo 'pending'; } ?>" >
            ...
            <td> <a class="btn btn-labeled " onclick="ajax_set_full('view','<?php echo translate('title'); ?>','<?php echo translate('successfully_edited!'); ?>','sales_view','<?php echo $row['sale_id']; ?>')" data-original-title="Edit" data-container="body">#<?php echo $row['order_id']; ?> 
             </a>                                 
            </td>
            ...
            <?php /*  <td><?php echo $row['cancel_remarks']; ?></td> */?>
             <!-- <td class="text-right">
