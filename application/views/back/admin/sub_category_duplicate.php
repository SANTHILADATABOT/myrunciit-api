...
?>
	<div class="tab-pane fade active in" id="edit">
		<?php
			echo form_open(base_url() . 'index.php/admin/sub_category/duplicate_new/' . $row['sub_category_id'], array(
				'class' => 'form-horizontal',
				'method' => 'post',
				'id' => 'sub_category_duplicate',
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <span id='wrap' class="pull-left" >
						...
						?>
						<input type="hidden" name="img" value="<?php echo $row['banner']; ?>">
