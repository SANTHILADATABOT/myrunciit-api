	    ...
	    <div class="col-md-12">
           <h1 class="page-header text-overflow">
				<?php echo translate('currency_settings')?>
                    ...
                    <br /><br /><br /><br />
                    <div class="">
                            <h3 class="panel-title" style="font-size:16px;"><?php echo translate('home_default_currency')?>s</h3>
                    </div>
                    <div class="panel-body">  
						<?php
					...
					<!----Second One---->
					<div class="">
                            <h3 class="panel-title2"><?php echo translate('system_default_currency')?>s</h3>
                    </div>
                    <div class="panel-body">  
						<?php
					...
					<!----Third One---->
					<div class="">
                       <h3 class="panel-title2"><?php echo translate('set_currency_format')?>s</h3>
                    </div>
                    <div class="panel-body">  
						<?php
                    ...
                    <br /><br />
                        <div class="">
                                <h3 class="panel-title2"><?php echo translate('all_currencies')?></h3>
                        </div>
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-list" style="border:1px solid #ebebeb; border-radius:4px;width="100%">
                              <thead>
                                <tr>
