<?php
    foreach($today_details as $row){
?>
<div class="row">
    <div class="col-md-12">
		<?php
		
			$today_id=	$today_details[0]['today_id'];
			
            echo form_open(base_url() . 'index.php/admin/product/todays_edit/'.$today_id, array(
                    ...
                    <div class="tab-content">
                    	<div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <?php
                                        echo $this->crud_model->select_html4('product','product','title','edit','demo-cs-multiselect',$today_details[0]['product_id'],'current_stock!=',0);
                                    ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5"><?php echo translate('today deals start date');?></label>
                                <div class="col-sm-6">
                                    <input type="date" name="today_start_date" id="today_start_date" min='0' step='.01' value="<?php echo $today_details[0]['toda_start_date']; ?>" placeholder="<?php echo translate('deal start date');?>" class="form-control required">
                                </div>
                            </div>  
                            
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5"><?php echo translate('today deals start time');?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5"><?php echo translate('today deals end date');?></label>
                                <div class="col-sm-6">
                                    <input type="date" name="today_end_date" id="today_deal_end_date" min='0' step='.01' value="<?php echo $today_details[0]['today_end_date']; ?>" placeholder="<?php echo translate('deal end date');?>" class="form-control required">
                                </div>
                            </div> 
                            
                            <div class="form-today btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5"><?php echo translate('today deals end time');?></label>
                                <div class="col-sm-6">
                ...
                <div class="row">
                	<div class="col-md-10">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right " 
                            onclick="ajax_set_full('today_edit','<?php echo translate('edit_today_deals'); ?>','<?php echo translate('successfully_edited!'); ?>','todays_edit',<?php echo $today_id ?>); "><?php echo translate('reset');?>
                        </span>
                    </div>
                    
                    <div class="col-md-2">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right enterer" onclick="form_submit('todays_edit','<?php echo translate('flash_deals_has_been_uploaded!'); ?>');proceed('to_add');" ><?php echo translate('upload');?></span>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#today_end_time').val('<?php echo $today_details[0]['today_end_time']; ?>');
        $('#today_start_time').val('<?php echo $today_details[0]['today_start_time']; ?>');
        set_select();
		set_summer();
		createColorpickers();
    });
