				  ...
				  <div class="row">
                    ...
                    <div class="tab-pane fade active in" id="" style="border:1px solid #ebebeb; border-radius:4px;">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title2"><?php echo translate('manage_details');?></h3>
                        </div>
						<?php
                        ...
                        ?>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="email" name="email" value="<?php echo $row['email']; ?>" id="demo-hor-2" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title2"><?php echo translate('change_password');?></h3>
                        </div>
							<?php
                            ...
                            ?>
                                ...
                                <div class="panel-footer text-center">
                                    <span class="btn btn-info pass_chng enterer" data-ing='<?php echo translate('updating..'); ?>' data-msg='<?php echo translate('password_updated!'); ?>'>
