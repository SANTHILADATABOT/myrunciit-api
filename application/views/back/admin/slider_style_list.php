                    ...
                    <div class="back_layer" style="display:none;">
                        <div class="ls-slide" <?php echo $style['full_slide_style']; ?> >
                            ...
                            <?php foreach($style['texts'] as $ind => $text){ ?>
                                <<?php echo $text['element']; ?> class="ls-l"  style="<?php echo $text['style']; ?> color:<?php echo $text['color']; ?>; background:<?php echo $text['background']; ?>;font-family: <?php echo $text['fontFamily']?>" data-ls="<?php echo $text['data_ls']; ?>" >
