...
<div class="panel-body" id="demo_s">
    <table id="bundle-table" class="table table-striped"  data-url="<?php echo base_url(); ?>index.php/admin/product_bundle/list_data" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]"  data-show-refresh="true" data-search="true"  data-show-export="true" >
        <thead>
            <tr>
