                ...
                <div class="col-sm-8">
                    ...
                    foreach($menu_main_list as $menu_main_list1)
                    {
                        ...
                        <tr>
                            ...
                            <td style="width:20px;"><input id="perm1_<?php echo $id1; ?>_0" class='sw_1' type="checkbox" value="perm1_<?php echo $id1; ?>_0" name="permission1['<?php echo $id1; ?>']['0']" data-id='perm1_<?php echo $id1; ?>_0' /></td>
                            <td style="width:20px;"><input id="perm2_<?php echo $id1; ?>_0" class='sw_1' type="checkbox" value="perm2_<?php echo $id1; ?>_0" name="permission2['<?php echo $id1; ?>']['0']" data-id='perm2_<?php echo $id1; ?>_0' /></td>
                            <td style="width:20px;"><input id="perm3_<?php echo $id1; ?>_0" class='sw_1' type="checkbox" value="perm3_<?php echo $id1; ?>_0" name="permission3['<?php echo $id1; ?>']['0']" data-id='perm3_<?php echo $id1; ?>_0' /></td>
                            <td style="width:20px;"><input id="perm4_<?php echo $id1; ?>_0" class='sw_1' type="checkbox" value="perm4_<?php echo $id1; ?>_0" name="permission4['<?php echo $id1; ?>']['0']" data-id='perm4_<?php echo $id1; ?>_0' /></td>
                            <?php } ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            foreach($menu_sub_list1[$menu_main_list1['id']] as $menu_sub_list2)
                            {
                                ...
                                <tr>
                                    ...
                                    <td style="width:20px;"><input id="perm1_<?php echo $id1; ?>_<?php echo $id2; ?>" value="perm1_<?php echo $id1; ?>_<?php echo $id2; ?>" class='sw_1 perm1_<?php echo $id1; ?>' type="checkbox" name="permission1['<?php echo $id1; ?>']['<?php echo $id2; ?>']" data-id='perm1_<?php echo $id1; ?>_<?php echo $id2; ?>' /></td>
                                    <td style="width:20px;"><input id="perm2_<?php echo $id1; ?>_<?php echo $id2; ?>" value="perm2_<?php echo $id1; ?>_<?php echo $id2; ?>" class='sw_1 perm2_<?php echo $id1; ?>' type="checkbox" name="permission2['<?php echo $id1; ?>']['<?php echo $id2; ?>']" data-id='perm2_<?php echo $id1; ?>_<?php echo $id2; ?>' /></td>
                                    <td style="width:20px;"><input id="perm3_<?php echo $id1; ?>_<?php echo $id2; ?>" value="perm3_<?php echo $id1; ?>_<?php echo $id2; ?>" class='sw_1 perm3_<?php echo $id1; ?>' type="checkbox" name="permission3['<?php echo $id1; ?>']['<?php echo $id2; ?>']" data-id='perm3_<?php echo $id1; ?>_<?php echo $id2; ?>' /></td>
                                    <td style="width:20px;"><input id="perm4_<?php echo $id1; ?>_<?php echo $id2; ?>" value="perm4_<?php echo $id1; ?>_<?php echo $id2; ?>" class='sw_1 perm4_<?php echo $id1; ?>' type="checkbox" name="permission4['<?php echo $id1; ?>']['<?php echo $id2; ?>']" data-id='perm4_<?php echo $id1; ?>_<?php echo $id2; ?>' /></td>
                                </tr>
                            <?php
                            } ?>
                            </table>
