                ...
                <div class="col-md-12"> 
                    <table class="table table-striped" style="border-radius:3px;">
                        ...
                        <tr>
                         ...
                         <tr>
                            <th class="custom_td"><?php echo translate('attachment');?></th>
                            <td class="custom_td">
                               <img class="img-md" src="<?php echo base_url(); ?>uploads/contact_image/<?php echo "contact_".$row['contact_message_id'].".jpg"; ?>" height="100px" />
                               <a href="<?php echo base_url(); ?>uploads/contact_image/<?php echo "contact_".$row['contact_message_id'].".jpg"; ?>" target="_blank">View</a>
                            </td>
                        </tr>
                        <tr>
