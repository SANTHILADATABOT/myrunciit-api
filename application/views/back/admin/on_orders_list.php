<div class="panel-body" id="demo_s">
    ...
    <div id='export-div' style="padding:40px;">
		...
		<table id="export-table" data-export-types="['excel','pdf']" data-show-export="true" class="table" data-name='sales' data-orientation='l' data-width='1500' style="display:none;">
				<colgroup>
					<col width="50">
					<col width="300">
					<col width="300">
