    <div class="panel-body" id="demo_s">
        <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-ignorecol="0,2" data-show-toggle="true" data-show-columns="false" data-search="true" >
            ...
            <tr>
                ...
                <td><a onclick="ajax_modal('view','<?php echo translate('view_contact_message'); ?>','<?php echo translate('successfully_viewed!'); ?>','contact_message_view','<?php echo $row['contact_message_id']; ?>');" data-original-title="Edit" data-container="body"><?php echo $row['subject']; ?>
                    </a></td>
