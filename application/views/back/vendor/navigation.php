            ...
            <div class="nano">
                <div class="nano-content">
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li class="list-header1"> <a href="<?php echo base_url(); ?>index.php/<?php echo $this->session->userdata('title'); ?>" >
                <img src="<?php echo $this->crud_model->logo('admin_login_logo'); ?>" alt="<?php echo $system_name;?>" class="brand-icon" >
                <div class="brand-title" style="display:none;">
                    <span class="brand-text"><?php echo $system_name;?></span>
                                    ...
                                    <ul class="collapse <?php if($page_name=="product" || 
                                        ...
                                        <?php
                                            ...
                                            <li <?php if($page_name == "product_bulk_upload"){?> class="active-link" <?php } ?> >
                                                <a href="<?php echo base_url(); ?>index.php/vendor/product_bulk_upload">
                                                    <i class="fa fa-circle fs_i"></i>
						...
						?>
                        <!--Menu list item-->
                        <li <?php if($page_name=="multi_store"){?> class="active-link" <?php } ?>>
                            <a href="<?php echo base_url(); ?>index.php/vendor/stores/">
                                <i class="fa fa-usd"></i>
                                    <span class="menu-title">
                                		<?php echo translate('my_store');?>
                                    </span>
                            </a>
                        </li>
                        ...
                        <li <?php if($page_name=="sales"){?> class="active-link" <?php } ?>>
                         ...
                         <li <?php if($page_name=="cancel_sales"){?> class="active-link" <?php } ?>>
                            <a href="<?php echo base_url(); ?>index.php/vendor/cancel_sales">
                                <i class="fa fa-usd"></i>
                                    <span class="menu-title">
