            ...
            <div class="panel-heading">
                <div class="panel-control" style="float: left;">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a data-toggle="tab" href="#bidding_deatils"><?php echo translate('Product Bidding'); ?></a>
                        </li>
...
<div class="form-group btm_border">
            ...
            foreach($stores as $storesdet){
                                    ...
                                    <option value="<?php echo $storesdet['store_id']; ?>"><?php echo $storesdet['store_name']; ?></option>
                                    <?php } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div id="bidding_deatils" class="tab-pane fade bidding_det">
                            <div class="form-group btm_border">
                             ...
                             <div class="col-sm-4">
                                	...
                                	<input type="radio" name="product_bid" id="no_product_bid" value="0" style="margin-right:5px;" checked>no
                                    </div>
                               </div>
