            ...
            <div class="panel-body">
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="" style="border:1px solid #ebebeb; border-radius:4px;">
                        ...
                        ?>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="email" name="email" readonly="readonly" value="<?php echo $row['email']; ?>" id="demo-hor-2" class="form-control required">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo translate('change_password  DEMO VERSION CAN NOT EDIT ');?></h3>
                        </div>
							<?php
                            ...
                            ?>
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" readonly="readonly" name="password" value="" id="demo-hor-5" class="form-control required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" readonly="readonly" name="password1" value="" id="demo-hor-6" class="form-control pass pass1 required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" readonly="readonly" name="password2" value="" id="demo-hor-7" class="form-control pass pass2 required">
                                        </div>
                                        <div id="pass_note">
                                        </div>
                                    </div>
