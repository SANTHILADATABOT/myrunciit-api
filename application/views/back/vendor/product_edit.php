            ...
            <div class="panel-heading">
                <div class="panel-control" style="float: left;">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a data-toggle="tab" href="#bidding_deatils"><?php echo translate('bidding deatils'); ?></a>
                        </li>
                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <label class="col-sm-4 control-label" for="demo-hor-2"><?php echo translate('Select_store');?></label>
                                <div class="col-sm-6">
                                    <select name="store_id" id="store_id" class="form-control unit required">
                                    <?php 
                               $stores=      $this->db->get_where('stores', array('status' => 'ok','vendor_id'=>$this->session->userdata('vendor_id')))->result_array();
            foreach($stores as $storesdet){
                                    ?>
                                    
                                    <option value="<?php echo $storesdet['store_id']; ?>" <?php if($storesdet['store_id']==$row['title']){ echo 'selected'; } ?>><?php echo $storesdet['store_name']; ?></option>
                                    <?php } ?>
                                    </select>
                                </div>
                            </div>
...
<div id="bidding_deatils" class="tab-pane fade bidding_det">
                            <div class="form-group btm_border ">
                            ...
                            <div class="form-group btm_border">
                             ...
                             <div class="col-sm-4">
                                    <input type="radio" name="product_bid" id="product_bid" value="1" <?php //if($row['bidding']==1) { ?>  <?php // } ?> style="margin-right:5px;">yes
                                	<input type="radio" name="product_bid" id="no_product_bid" value="0"  <?php //if($row['bidding']==0) { ?> checked="checked" <?php  // } ?>  style="margin-right:5px;">no
                                    </div>
                               </div>
                            <div class="form-group btm_border bidding">
                                <label class="col-sm-4 control-label" for="demo-hor-6"><?php echo translate('bidding start date');?></label>
                                <div class="col-sm-4">
                                    <input type="date" name="bid_start_date" id="bid_start_date" min='0' step='.01' value="<?php echo $row['bid_start_date']; ?>" class="form-control required">
                                </div>
                                <!--<span class="btn"><?php //echo currency('','def'); ?> / </span>
                            ...
                            <div class="form-group btm_border bidding">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="bid_start_time" id="bid_start_time" min='0' step='.01'  value="<?php echo $row['bid_start_time']; ?>" class="form-control required">
                                </div>
                                <!--<span class="btn"><?php //echo currency('','def'); ?> / </span>
                                <span class="btn unit_set"></span>-->
                            </div>
                            ...
                            <div class="form-group btm_border bidding">
                                ...
                                <div class="col-sm-4">
                                    <input type="date" name="bid_end_date" id="bid_start_date" min='0' step='.01'  value="<?php echo $row['bid_end_date']; ?>" class="form-control">
                                </div>
                               <!-- <span class="btn"><?php //echo currency('','def'); ?> / </span>
                                <span class="btn unit_set"></span>-->
                            </div>
                            ...
                            <div class="form-group btm_border bidding">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="bid_end_time" id="bid_end_time" min='0' step='.01' value="<?php echo $row['bid_end_time']; ?>" class="form-control">
                                </div>
                                <!--<div class="col-sm-1">
                                    <select class="demo-chosen-select" name="tax_type">
                            ...
                            <div class="form-group btm_border bidding">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="max_bid_amount" id="max_bid_amount" min='0' step='.01' placeholder="<?php echo translate('maximum bidd amount');?>" value="<?php echo $row['max_bid_amount']; ?>" class="form-control">
                                </div>
                                <!--<div class="col-sm-1">
                                    <select class="demo-chosen-select" name="discount_type">
                                        <option value="percent">%</option>
                            ...
                            <div class="form-group btm_border bidding">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="min_bid_amount" id="min_bid_amount" min='0' step='.01' placeholder="<?php echo translate('minimum bidd amount');?>" value="<?php echo $row['min_bid_amount']; ?>" class="form-control">
                                </div>
                                <!--<div class="col-sm-1">
                                    <select class="demo-chosen-select" name="discount_type">
                                        <option value="percent">%</option>
