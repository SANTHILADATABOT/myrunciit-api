...
?>
		<audio style='display:none;' id='<?php echo $row; ?>'>
			<source type="audio/mpeg" src="<?php echo base_url(); ?>uploads/audio/admin/<?php echo $row; ?>.mp3">
		</audio>
<?php
	}
}
...
<script type="text/javascript">
	...
	function session_check() {
		$.ajax({
			...
			success: function(data) {
				if (data == 'yah!good') {} else if (data == 'nope!bad') {
