...
<!-- <section style="margin-top: 30px;">
    <div class="container">
        <div class="homepage-slider" id="slider">
            <div class="slider-items">
                <picture> 
                <source media="(min-width: 768px)" srcset="<?php echo base_url(); ?>uploads/slider_image/background_5<?php echo $row1['slider_id']; ?>.jpg">
                <img src="<?php echo base_url(); ?>uploads/slider_image/background_5<?php echo $row1['slider_id']; ?>.jpg" alt="New Year Deals">
                </picture>
            </div>
        </div>
    </div>
	...
	<div id="full-slider-wrapper" style="margin-bottom:30px">
		...
		<?php
            ...
            <div class="ls-slide" <?php echo $style['full_slide_style']; ?> >
                ...
                <?php 
                	foreach($style['images'] as $ind => $image){ 
                ...
                <?php 
                	foreach($style['texts'] as $text){
                		...
                		if($txt !== ''){
                ?>
                    <<?php echo $text['element']; ?> class="ls-l" style="<?php echo $text['style']; ?> color:<?php echo $color; ?>; background:<?php echo $background; ?>;font-family: <?php echo $fontFamily?>" data-ls="<?php echo $text['data_ls']; ?>" >
                        <?php echo $txt; ?>
