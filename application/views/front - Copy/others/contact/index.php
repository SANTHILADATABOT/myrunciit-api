            ...
            <div class="col-md-7 text-left">
                ...
                <!-- Contact form -->
                    ...
                    <div class="outer required">
                     ...
                     <div class="outer required">
                        <div class="form-group af-inner">
                            <label class="sr-only" for="upload">
                                <?php echo translate('upload');?>
                            </label>
                            <input type="file"class="form-control placeholder test"  data-toggle="tooltip" 
                                title="<?php echo translate('upload');?>" name="img" id="img" size="30"
