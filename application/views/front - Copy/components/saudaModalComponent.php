                    ...
                    <div class="row mtsd">
                        ...
                        <div class="col-md-6 col-md-offset-3 dstf">
                            <div class="col-md-6 col-xs-6 col-sm-6 gtdf">
                                <div class="box_p">
                                    <a href="javascript:void(0);" onClick="set_pops2('pops_0','pops_3','pickup')">
                                        <div class="box_img">
                ...
                <div id="pops_3" style="display:none">
                    <div class="clearfix">
                        ...
                        <div class="form-group clearfix">
                            ...
                            <?php $store_address =  $this->db->get_where('vendor', array('status' => 'approved', 'pickup' => 'yes'))->result_array();
                            foreach ($store_address as $store_info) { ?>
                                <p style="text-align: left;">
                                    <input value="<?php echo $store_info['vendor_id']; ?>" class="storeType" type="radio" name="pickup">
                        ...
                        <div class="form-group clearfix">
                            ...
                            <form id="form3" method="post">
                                ...
                                <div class="col-lg-12" id="slotSection">
                                    ...
                                    <div><a href="javascript:void(0);" onClick="set_pops2('pops_3','pops_0')">Back</a></div>
