                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="logo">
                                <a href="<?php echo $this->crud_model->vendor_link($vendor_id); ?>">
                                    ...
                                    <img class="img-circle" src="<?php echo base_url();?>uploads/vendor_logo_image/logo_<?php echo $vendor_id;?>.png" alt="Shop"/>
                                    <?php }else{?>
                                        <img class="img-circle" src="<?php echo base_url();?>uploads/vendor_logo_image/default.jpg" alt="Shop"/>
                                    <?php }?>
                                </a>
                            </div>
                            <!-- /Logo -->
                            <div class="info">
                                ...
                                <h6>
                                    <i class="fa fa-user"></i><?php echo translate('member_since');?>: 
                                    <?php echo date("d M, Y", $this->crud_model->get_type_name_by_id('vendor',$vendor_id,'create_timestamp'));?>
                                    <br>
                                    <i class="fa fa-envelope" aria-hidden="true"></i><?php echo translate('email');?>:
                                	<?php echo $this->crud_model->get_type_name_by_id('vendor',$vendor_id,'email');?>
                                </h6>
                                <h6 class="hidden-sm hidden-xs">
                                   <i class="fa fa-globe" aria-hidden="true"></i> <?php echo $this->crud_model->get_type_name_by_id('vendor',$vendor_id,'address1');?>
                                    <br>
