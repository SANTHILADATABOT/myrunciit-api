                    	...
                    	<div class="details-wrap">
                            ...
                            <?php if ($upload_amount <= 0){ ?>
                                ...
                                <div class="text-center">
                                    <a href="<?=base_url()?>index.php/home/premium_package" class="btn btn-theme"><?=translate('purchase_package')?></a>
                                </div>
                            <?php } else { ?>
                                <p class="text-success"><?=translate('remaining_product_upload_amount:_').$upload_amount;?></p>
                                <div class="details-box">
                                    <?php
                                        echo form_open(base_url() . 'index.php/home/profile/do_post_product/', array(
                                            'class' => 'form-login',
                                            'method' => 'post',
...
<script>
    ...
    function get_sub_cat(category_id) {
        ajax_load(base_url+'index.php/home/get_dropdown_by_id/sub_category/category/'+category_id+'/sub_category_name/0','post_sub_category', 'set_elements');
    }
