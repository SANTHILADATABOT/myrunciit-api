               ...
               <div class="row">
                  <div class="col-6-12">
                     ...
                     <div class="row">
                        ...
                        <div class="col-8-12">
                           <div class="_3D-3p2">
                              <span class="row _13y4_y _1iu0PI"><?php echo $prd['name']; ?></span>
                  ...
                  <div class="col-2-12 JL36Xz"> <a class="" href="<?php echo base_url(); ?>index.php/home/invoice_details/<?php echo $row1['order_id']; ?>/<?php echo $row1['sale_id']; ?>"><?php echo currency($row1['grand_total']); ?></a></div>
