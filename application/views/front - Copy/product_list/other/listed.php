<div class="pagination-wrapper top hidden">
...
<div class="row products <?php echo $viewtype; ?>">
    ...
    ?>
    <div class="col-md-<?php echo $col_md; ?> col-sm-<?php echo $col_sm; ?> col-xs-<?php echo $col_xs; ?> padd0">
        <?php echo $this->html_model->product_box($row, $viewtype, '2'); ?>
    </div>
    <?php
        }
    ?>
