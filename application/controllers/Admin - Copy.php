...
class Admin extends CI_Controller
{
    ...
    function product($para1 = '', $para2 = '', $para3 = '')
    {
        ...
        elseif ($para1 == 'update_split_edit') {
            ...
            foreach ($products as $row) {
                ...
                $res['store_name']  = $this->db->get_where('vendor', array(
				...
				<a class=\"btn btn-success btn-xs btn-labeled fa fa-wrench\" data-toggle=\"tooltip\" 
                            ...
                            <a class=\"btn btn-primary  btn-xs btn-labeled fa fa-puzzle-piece\" data-toggle=\"tooltip\" onclick=\"ajax_set_full('duplicate','".translate('duplicate_product')."','".translate('successfully_duplicated!')."','product_duplicate','".$row['product_id']."');proceed('to_list');\" data-original-title=\"Duplicate\" data-container=\"body\">" . translate('duplicate') . "
                            </a>
    ...
    function sales($para1 = '', $para2 = '', $para3 = '', $para4 = '', $para5 = '', $para6 = '', $para7 = '', $para8 = '')
    {
            ...
            foreach($menu_main_list as $menu_main_list1)
            {
                ...
                if($menu_main_list1['have_sub']=="1"){
                    foreach($menu_sub_list1[$id1] as $menu_sub_list2)
                    {
                        ...
                        $data1['view_rights']=($perm1[$id1][$id2]=="perm1_".$id1."_".$id2)?"1":"0";
                        $data1['add_rights']=($perm2[$id1][$id2]=="perm2_".$id1."_".$id2)?"1":"0";
                        $data1['edit_rights']=($perm3[$id1][$id2]=="perm3_".$id1."_".$id2)?"1":"0";
                        $data1['delete_rights']=($perm4[$id1][$id2]=="perm4_".$id1."_".$id2)?"1":"0";
    ...
    function whatsapp_message($para1 = '', $para2 = '')
    {
        ...
        if ($para1 == 'do_add') {
            ...
            // exit;
            $phoneNumbers  = explode(',', $this->input->post('phoneNumbers'));
            $sid    = "AC2b13631e4c49efe64b1ad32ced0afa6e";
            $token  = "7f4640bd1741efe73038095de8ca7c3a";
                        ...
                        if ($inc > 1) {
                            ...
                            if ($value['A'] != '') {
                                ...
                                if ($product_id == '') {
                                    ...
                                    if ($value['N'] != '')
                                        $inserdata['discount_type']         = $value['N'];
                                    else
                                        $inserdata['discount_type']         = '';
                                    ...
                                    $inserdata['color']      = '["rgba(204,204,204,1)"]';
                                    $inserdata['added_by']             = json_encode(array('type' => 'admin', 'id' => '1'));
                                    $store_id = $this->db->get_where('vendor', array('name' => $value['O']))->row()->vendor_id;
                                    ...
                                    $result1 = $this->db->insert('stock', $stockData);
                                        ...
                                        $this->session->set_flashdata('error', translate('Check the Store Name in File'));
                                        redirect('admin/product_bulk_upload');
                                    }
                                    ...
                                    if ($value['J'] != '')
                                        ...
                                        $inserdata['current_stock']         = $value['J'] + $stock;
                                    else
                                        $inserdata['current_stock']         = $stock;
