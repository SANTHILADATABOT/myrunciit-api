...
//echo $this->db->last_query();
		...
		//	print_r($final_email); exit;
			$send_mail  = $this->crud_model->elastic_mail($from,$from_name,$to, $sub, $final_email);
			}else{
			//	$send_mail  = $this->do_email($from,$from_name,$to, $sub, $email_body);
			$send_mail  = $this->crud_model->elastic_mail($from,$from_name,$to, $sub, $email_body);
			}
    ...
    {   
        ...
        $send_mail  = $this->crud_model->elastic_mail($from,$from_name,$to, $sub, $msg);
        if($this->email->send()){
            return true;
        }else{
